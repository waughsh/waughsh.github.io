...
I will list those articles based on themes, or relevancy, or (fancier) timelines. I won't discuss in great detail the content of the paper, but I'll leave my comments.
...
- **Recurrent Dropout without Memory Loss**
   ...
   Comments: This is one of my most favorite papers so far. It breaks down dropout, and RNN, and discuss what approach is correct and what is incorrect, in terms of retaining as much memory as possible, while harnessing the power of dropout generalization.
